...
public final class Configs {
	...
	private static void loadNormalConfig(final File configFile, final boolean client) {
		...
		try {
			...
			TileEntityAdminSolar.settings = new TileEntitySolarPanel.SolarConfig(config.get("Light-Absord solar panels", "Light-AbsordGenDay", 163840).getInt(163840), config.get("Light-Absord solar panels", "Light-AbsordGenNight", 163840).getInt(163840), config.get("Light-Absord solar panels", "Light-AbsordStorage", 100000000).getInt(100000000), config.get("Light-Absord solar panels", "Light-AbsordTier", 8).getInt(8), config.get("Light-Absord solar panels", "Light-AbsordTier", 327680).getInt(327680));
			...
			TileEntityAdminRain.settings = new TileEntityRainPanel.SolarConfig(config.get("Light-Absord Rain panels", "Light-AbsordGenRain", 327680).getInt(327680), config.get("Light-Absord solar panels", "Light-AbsordStorage", 100000000).getInt(100000000), config.get("Light-Absord solar panels", "Light-AbsordTier", 8).getInt(8), config.get("Light-Absord Rain panels", "Light-AbsordTier", 327680).getInt(327680));
...
//
			...
			TileEntityAdminMoon.settings = new TileEntityNightPanel.SolarConfig(config.get("Light-Absord Moon panels", "Light-AbsordGenMoon", 327680).getInt(327680), config.get("Light-Absord Moon panels", "Light-AbsordStorage", 100000000).getInt(100000000), config.get("Light-Absord Moon panels", "Light-AbsordTier", 8).getInt(8), config.get("Light-Absord Moon panels", "Light-AbsordTier", 327680).getInt(327680));
			...
			TileEntityAdminSun.settings = new TileEntitySunPanel.SolarConfig(config.get("Light-Absord Sun panels", "Light-AbsordGenSun", 327680).getInt(327680), config.get("Light-Absord Sun panels", "Light-AbsordStorage", 100000000).getInt(100000000), config.get("Light-Absord Sun panels", "Light-AbsordTier", 8).getInt(8), config.get("Light-Absord Sun panels", "Light-AbsordTier", 327680).getInt(327680));
